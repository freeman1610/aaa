        ...
        Swal.fire({
            ...
            html:
                '<form action="" name="formularioCrearNomina" id="formularioCrearNomina" method="POST">'+
                    ...
                    '<br><label for="" class="d-flex justify-content-start">Dias de Libres(*):</label><input class="form-control" type="text" name="dias_lib_a" id="dias_lib_a" minlength="1" required placeholder="Días de Descanso" autocomplete="off" onkeypress="return SoloNumeros(event)" minlength="0" maxlength="2" onkeyup="contarNumsMensual()">'+
