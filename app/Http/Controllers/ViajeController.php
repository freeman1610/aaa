...
class ViajeController extends Controller
{
    public function listar_viajes()
    {
        ...
        foreach ($selectViajes as $datos) {
            ...
            $arrayDatos[] = [
                ...
                "2" => $selectChofer[0]->nombre . ' ' . $selectChofer[0]->apellido . ' | C.I: ' . $selectChofer[0]->cedula,
                "3" => '<table class="table table-bordered table-striped dataTable dtr-inline"><tr><td> Flete Ida: </td><td></td></tr><tr><td> dos</td><td>AAA</td></tr></table>',
                "4" => $datos->viajes_descripciondelacargar,
                "5" => '<table class="table table-bordered table-striped dataTable dtr-inline"><tr><td> contenido </td><td> xd</td></tr><tr><td> dos</td><td>AAA</td></tr></table>',
                "6" => '<table class="table table-bordered table-striped dataTable dtr-inline"><tr><td> IDA: </td><td> ' . $datos->viajes_dia_salida . '</td></tr><tr><td>RETORNO:</td><td>' . $datos->viajes_dia_retorno . '</td></tr></table>',
    ...
    public function crear_viaje(Request $request)
    {
        ...
        if (isset($request->viaje_flete_ida) && isset($request->viaje_flete_retorno)) {
            ...
            $chofer = Chofer::find($request->viaje_chofer);
            $chofer->chofer_estado = 1;
            $chofer->save();
        ...
        if (isset($request->viaje_flete_ida)) {
            $this->validate($request, [
                'viaje_codigo' => 'required',
                'viaje_chofer' => 'required|numeric',
                'viaje_chuto' => 'required|numeric',
        ...
        if (isset($request->viaje_flete_retorno)) {
            $this->validate($request, [
                'viaje_codigo' => 'required',
                'viaje_chofer' => 'required|numeric',
                'viaje_chuto' => 'required|numeric',
