...
$.ajax({
    url: 'count_items_index',
    type: 'POST',

    success: function (res) {
        $('#viajes_curso').text(res.viajes)
        $('#empleados').text(res.empleados)
    }
});

/**
 * Graficas para los chutos mas usados durante en el mes
 */
$.ajax({
    url: 'chutos_mes',
    type: 'POST',
    ...
    success: function (res) {
        ...
        new Chart(ctx, {
            type: 'bar',
            data: {
                // el res res.placas trae un string de esta forma: ""044ADA33","0A-DAA0","C455AA","DDD32""
                // ChartJS lo tiene que interpretar es asi "044ADA33","0A-DAA0","C455AA","DDD32"
...
/**
 * Graficas de los Estados mas visitados este mes
 */
...
// var egresos = new Chart(ctx, {
//     type: 'bar',
//     data: {
//         labels: [<? php echo $fechasv ?>],
//         datasets: [{
//             label: '# Egreso en BS/. de los últimos 12 meses',
